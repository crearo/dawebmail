...
public class MailAdapterRecycler extends RecyclerView.Adapter<MailAdapterRecycler.ViewHolder> {
    ...
    public MailAdapterRecycler(Context context, ArrayList<EmailMessage> emails) {
    ...
    @Override
    public MailAdapterRecycler.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.element_email, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(MailAdapterRecycler.ViewHolder holder, final int position) {
